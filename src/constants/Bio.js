export const Bio = {
    ...
    resume:
        "https://drive.google.com/file/d/1KLL2SzGmsQdR3Oj0abH0jA9ogPkuaTfp/view?usp=drive_link",
...
export const projects = [
    {
        ...
        date: "2023",
        description:
            "Create a website landing page display using HTML, CSS and JS. CSS and JS are used to make the landing page display responsive.",
        image:
            "https://raw.githubusercontent.com/diotrier/personalportfolio.github.io/master/image/project3.PNG",
        tags: [
            "React Js",
            "PostgressSQL",
            "Node Js",
    ...
    {
        id: 9,
        title: "Anlysis Covid-19 Indonesia",
        date: "2022",
        description:
            "This project was created to analyze the development of Covid in Indonesia using the SQL query language. by using public data from kaggle.com and to visualize data using tabelau.",
        image:
            "https://raw.githubusercontent.com/diotrier/personalportfolio.github.io/master/image/project2.png",
        tags: [
            "Docker",
            "AWS",
            "DuckDNS",
    ...
    },
    {
        ...
        date: "2023",
        description:
            "Developed a full-stack web application that allows users to search for movie.",
        image:
            "/assets/p2.png",
